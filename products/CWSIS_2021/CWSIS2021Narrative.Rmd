...
The purpose of this social impact scholarship project is to generate pilot data and establish proof of concept to expand the capabilities and infrastructure of Auburn University's Quantitative Methods in Education Research (QMER) learning community.
Promoting diversity and increasing interest in STEM skills related to the use of the overwhelming amount of data available today is key to our country's prosperity.

The mission of QMER is to empower students to harness the data revolution by fostering fundamental data science research skills which will promote a data capable workforce in Alabama and beyond.
We do this by providing students and faculty free hands-on workshops related to modern research skills using open-source software, access to large national data sets along with increased computational resources, and opportunities to get involved with research with minimal prerequisites. 
Since its inception two years ago, the impact of QMER has grown from working with graduate students and faculty in the College of Education to include participation across campus.
Based on what we have learned over this time, we are now poised to expand the impact of QMER beyond the university.
Our goal is to build a network across Alabama educational institutions, particularly non-intensive research institutions that do not have the research infrastructure of a very high intensity research university.
Collaboration with such institutions will expose undergraduates, many of them historically under-represented students, to research, encourage them to pursue further education in STEM fields, and remove barriers to pursuing graduate work at institutions such as Auburn University.
To do so will require federal funding to increase our capabilities and infrastructure.

To secure such funding we have the following aims.
First, to use the CWSIS funding to collect initial evidence that participation in the QMER learning community can promote the skills needed to succeed in data dependent STEM careers, as well as promote self-efficacy and interest in pursuing a STEM career.
Second, we also want to identify barriers to participation by HUS in STEM fields as well as strengths they use to overcome those barriers. Finally, we want to know what barriers non-research intensive institutions face and what strengths they utilize to overcome these barriers.
By identifying the strengths and barriers of student and institution we will be better positioned to leverage the Auburn university research infrastructure to promote participation in STEM graduate work. 
As outlined below, this network will play an important role in realizing key aspects of Auburn University's Strategic Plan and Big Four Research Commitments.

Research questions: 

1. Does participation in the QMER learning community improve **research skills**  and **efficacy and confidence**? 
2. What **barriers** to STEM participation do *historically under-represented students* face, and what **strengths** do they utilize to overcome these barriers?
3. What **barriers** do *non-research intensive institutions* face and what **strengths** do they posses to overcome these barriers?

---

The p
which will play a important role in realizing key aspects of Auburn University's Strategic Plan and Big Four Research Commitments as outlined below. 
The data and results of the proposed study will lay the foundation for seeking federal funding from the National Science Foundation’s EHR Core Research (ECR): Building Capacity in STEM Education Research Grant (ECR: BCSER).
The following three research questions frame this effort.



The QMER learning community 

This data will be used to seek federal funding.
The data will also be used to develop a survey related to barriers to success for historically underrepresented students.
...
Increasing need for STEM careers.
Combined with the expectation that by 2050 minorities will comprise 53% of the population [cite census bureau in NSF Grand Challenges].
There is considerable need to attract more minorities and other underrepresented students to STEM fields.
...
Changing the educational pipeline from pre-k to graduate school is critical to meeting these changing societal needs. 
Therefore, educational researchers are critical to solving the problems of STEM involvement. [We have to make this case well. I think it is the best way to address Andrew's point about us not being in STEM]

[QMER long-term solution]
...
flatten prerequisites to STEM skills through computational and other technological skills, 

Student-driven experiences, applying skills to real data in an active learning environment. 
Flexible curriculum in-person and online (both synchronous, asynchronous).
Students are able to participate in QMER early in there 

### Transformative Research

increase and strengthen Auburn's research-intensive student population and research culture.

Expand the capabilities and infrastructure of research 
...
"fundamental data science research" skills
"data capable workforce"

massive amounts of data, expanding computational capabilities, and new algorithms for discovering relations and patterns in data.
promote generating new knowledge and innovation

transcend existing scientific structures and standard operating procedures

STEM inclusion network that will eventually scale up to the national level

access and inspiration

[CWSIS focused solution and RQs]
